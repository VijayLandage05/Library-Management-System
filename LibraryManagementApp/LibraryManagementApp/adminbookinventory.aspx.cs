...
namespace LibraryManagementApp
{
    public partial class adminbookinventory : System.Web.UI.Page
    {
        ...
        //Inorder to work with image, actual stock,current stock and issued stock
        static string global_filepath;
        static int global_actual_stock, global_current_stock, global_issued_books;
        protected void Page_Load(object sender, EventArgs e)
        {
            // to chnage the auto selected author and publisher
            if (!IsPostBack)
            {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Book already exists with this ID, try with some other ID');</script>");
            }
            else
            {
                addNewBook();
        ...
        void getBookByID()
        {
            try
            {
                ...
                //For selection only author name from table and show it in dropdownlist
                ...
                if (dt.Rows.Count >= 1)
                {
                    ...
                    // to iterate over genre and strore in array and return multiselect genre
        ...
        void fillAuthorPublisherValues()
        {
            try
            {
                ...
                //For selection only publisher name from table and show it in dropdownlist
        ...
        void addNewBook()
        {
            ...
            {
                string genres = "";
                // To select multiple values in genres
                foreach (int i in ListBox1.GetSelectedIndices())
                {
                    genres = genres + ListBox1.Items[i] + ",";
                }
