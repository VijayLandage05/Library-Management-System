<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminpublishermanagement.aspx.cs" Inherits="LibraryManagementApp.adminpublishermanagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <%--For publisher management web page--%>
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                   <%--In order to wrap id and button in single line we have used another div class input-group--%>
                        ...
                        <%--Three buttons for Add, Update and Delete functionality--%>
                        <div class="row">
                            <div class="col-4">
             ...
             <%--Another div to show publisher list beside first div--%>
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
