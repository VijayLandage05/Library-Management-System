<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookissuing.aspx.cs" Inherits="LibraryManagementApp.adminbookissuing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <%--adminbookissuing functionality--%>

    <div class="container-fluid">
        <div class="row">
           
            <%--5 columns for book issuing--%>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <%--two buttons for Add and Return book functionality--%>
           ...
           <%--Another div to show book issued list beside first div--%>
