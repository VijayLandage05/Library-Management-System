<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminauthormanagement.aspx.cs" Inherits="LibraryManagementApp.adminauthormanagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--For author management web page--%>
    <div class="container">
        <div class="row">
            <div class="col-md-5">
            ...
            <%--Another div to show Author list beside first div--%>
            <div class="col-md-7">
