...
{
    public partial class adminmemberamanagement : System.Web.UI.Page
    {
        ...
        {
            updateMemeberStatusByID("active");
        }

        //Pending status button
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            updateMemeberStatusByID("pending");
        }

        // Delete status button
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            updateMemeberStatusByID("deactivated");
        }
        ...
        void getMemberByID()
        {
            try
            {
                ...
                if (dr.HasRows)
                {
                    while (dr.Read())
                    {
                        //To show readonly properties in member profile form
        ...
        void updateMemeberStatusByID(string status)
        {
            if (checkIfMemberExists())
            {
                try
