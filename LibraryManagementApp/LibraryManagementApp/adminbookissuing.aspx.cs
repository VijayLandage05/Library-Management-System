    ...
    public partial class adminbookissuing : System.Web.UI.Page
    {
        ...
        void returnBook()
        {
            try
            {
                ...
                //result will hold no. of rows affected due ti above query
        ...
        bool checkIfIssueEntryExist()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from book_issue_tbl WHERE member_id='" + TextBox2.Text.Trim() + 
        ...
        //for filling red color to defaulters list we have used RowDataBound
